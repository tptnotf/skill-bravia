...
URL = "https://github.com/builderjer/skill_bravia"
SKILL_CLAZZ = "BraviaSkill"  # needs to match __init__.py class name
PYPI_NAME = "skill-bravia"  # pip install PYPI_NAME
...
setup(
    ...
    keywords='ovos skill plugin bravia',
